...
def update_desktop_bg(temp):
    ...
    draw.text(
        (640 - text_size[0] / 2, 310 - text_size[1] / 2),
        text, (255, 255, 255),
        font=font)
...
subprocess.run(['feh', '--bg-fill', '--no-fehbg', '/home/jrutledge/safe/personal/developer/python/dynamic_desktop_background/graphics/solarized_bg_set/rain.png'])
